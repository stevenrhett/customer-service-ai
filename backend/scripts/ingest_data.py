...
# Simple text splitter (avoiding langchain_text_splitters dependency issues)
class RecursiveCharacterTextSplitter:
    """Simple text splitter that chunks documents by character count."""
...
class DataIngester:
    ...
    def ingest_all(self):
        ...
        billing_docs = self.load_documents_from_directory(
            self.base_path / "billing", "billing"
        )
        ...
        technical_docs = self.load_documents_from_directory(
            self.base_path / "technical", "technical"
        )
