...
class CacheService:
    ...
    def get_cache_query_response(self, query: str, session_id: str, agent_type: str) -> Optional[str]:
        """
    ...
    def set_cache_query_response(self, query: str, session_id: str, agent_type: str, response: str, ttl_seconds: int = 3600):
        """
    ...
    def get_cached_documents(self, query: str, collection_name: str, k: int) -> Optional[List[Document]]:
        """
    ...
    def set_cached_documents(self, query: str, collection_name: str, k: int, documents: List[Document], ttl_seconds: int = 7200):
        """
